...
#################################### 节点参数配置 ########################################################
    # 导航功能包的路径
    navigation2_dir = get_package_share_directory('elementbot_navigation')
    ...
    nav2_param_path = LaunchConfiguration('params_file',default=os.path.join(navigation2_dir,'param','elementbot_nav2.yaml'))
    # rviz可视化显示的配置文件路径
